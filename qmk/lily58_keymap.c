...
[_LOWER] = LAYOUT(
  ...
  _______, _______, _______, _______, _______, _______,                   _______, _______, _______,_______, _______, _______,
  _______, _______, _______, _______, _______, _______, _______, _______, KC_GRV, KC_TILD, KC_BSLS, KC_PIPE, _______, _______,
                             _______, _______, _______, _______, _______,  _______, KC_DEL, _______
),

/* RAISE
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * | Home | Pg+  | Pg-  | End  | Bri- | Bri+ |                    |      |      | Mute | Vol- | Vol+ |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |      |      |  Up  |      |      |      |                    |      |      |Pause | Prev | Next |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |      | Left | Down |Right |      |      |-------.    ,-------|      |      |      |      |      |      |
 ...
 */
[_RAISE] = LAYOUT(
  KC_HOME, KC_PGUP, KC_PGDN, KC_END, KC_BRID, KC_BRIU,                      _______, _______, KC_KB_MUTE, KC_KB_VOLUME_DOWN, KC_KB_VOLUME_UP, _______,
  _______, _______, KC_UP, _______, _______, _______,                       _______, _______, KC_MPLY, KC_MPRV, KC_MNXT, _______,
